...
import * as import9 from '../../app/photo/photo.component';
import * as import10 from './photo/photo.component.ngfactory';
...
export class View_AppComponent0 extends import1.AppView<import0.AppComponent> {
  ...
  _text_2:any;
  _el_3:any;
  compView_3:import1.AppView<import9.PhotoComponent>;
  _PhotoComponent_3_3:import10.Wrapper_PhotoComponent;
  _text_4:any;
  /*private*/ _expr_7:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._el_3 = import3.createRenderElement(this.renderer,parentRenderNode,'app-photo',import3.EMPTY_INLINE_ARRAY,(null as any));
    this.compView_3 = new import10.View_PhotoComponent0(this.viewUtils,this,3,this._el_3);
    this._PhotoComponent_3_3 = new import10.Wrapper_PhotoComponent();
    this.compView_3.create(this._PhotoComponent_3_3.context);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import9.PhotoComponent) && (3 === requestNodeIndex))) { return this._PhotoComponent_3_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    this._PhotoComponent_3_3.ngDoCheck(this,this._el_3,throwOnChange);
